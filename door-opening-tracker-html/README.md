...
- Door-opening compliance: NB (`319`, `320`, `321`, `738`) at `02:30`; WB (`777`, `787`, `789`) at `03:30`.
- Separate Late Door Closings section using a `Door Closing (Mins.)` column when available.
- Assign agents from the bundled Universal Employee Searcher roster; CSM fills automatically.
